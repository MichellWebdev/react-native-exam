...
export const EVENTS = [
    new DiscoverEvent('1', 'Event 1', 'Group 1', event1, new Date(2021, 3, 12, 13, 0, 0), new Date(2021, 3, 13, 17, 0, 0), 'Copenhagen', 'This is a sample event 1 from group 1.', [SCHEDULES[0], SCHEDULES[1], SCHEDULES[2], SCHEDULES[3]], [USERS[0], USERS[1]], [USERS[0]]),
    new DiscoverEvent('2', 'Event 2', 'Group 2', event2, new Date(2021, 3, 13, 13, 0, 0), new Date(2021, 3, 13, 16, 0, 0), 'Korea', 'Event 2 from group 2.', [SCHEDULES[4], SCHEDULES[5], SCHEDULES[6]], [USERS[0], USERS[1], USERS[2]], [USERS[1], USERS[2]])
];
